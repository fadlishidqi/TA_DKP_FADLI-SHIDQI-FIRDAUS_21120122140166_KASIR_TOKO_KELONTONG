...
class LoadingScreen:
    # Inisialisasi class LoadingScreen
    def __init__(self, root):
        self.root = root
        self.root.geometry("500x300")
        self.root.title("Ini Namanya Loading Screen...")

        # variabel DoubleVar untuk menyimpan nilai progress
        self.progress_var = DoubleVar()

        # frame untuk menampung komponen loading
        ...
        # progressbar dengan pengaturan yang ditentukan
    ...
    def start_loading(self, progressbar):
        # Set nilai progress awal menjadi 0
...
class AplikasiBilling:
    ...
    def total(self):
        ...
        # Pengkondisian jika barang yg dibeli 0
